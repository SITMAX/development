        ...
        <script type="text/javascript">
                                    ...
                                    if (form.getForm().isValid()) {
                                        if (form.getForm().isValid()) {
                                            var store = new Ext.data.JsonStore({
                                                url: Ext.SROOT + 'swi/simgeisrv/buscarAvanzada',
                                                root: 'data',
                                                fields: [
                                                    {name: 'id'},
                                                    {name: 'nombre'},
            ...
            domain.functions = {
                registroForm: function (options) {
                    var store = new Ext.data.JsonStore({
                        url: Ext.SROOT + 'swi/simgeisrv/buscarDireccion',
                        root: 'data',
                        fields: [
                            {name: 'activo'},
                            {name: 'codPostal'},
            ...
            domain.Panel = {
                init: function () {
                        ...
                        buttons: [{
                                ...
                                handler: function () {
                                    if (form.getForm().isValid()) {
                                        if (form.getForm().isValid()) {
                                            var store = new Ext.data.JsonStore({
                                                url: Ext.SROOT + 'swi/simgeisrv/buscarDocumento',
                                                root: 'data',
                                                fields: [
                                                    {name: 'id'},
                                                    {name: 'nombre'},
                    ...
                    var formSearchID = new Ext.FormPanel({
                        frame: true,
                        url: Ext.SROOT + 'swi/simgeisrv/buscarid',
                        region: 'north',
                        autoHeight: true,
                        bodyStyle: 'padding:10px',
                        labelWidth: 120,
                                    ...
                                    if (formSearchID.getForm().isValid()) {
                                        formSearchID.getForm().submit({
                                            success: function (form, action) {
                                                ...
                                                var form = domain.functions.registroForm({});
                        ...
                        buttons: [{
                                ...
                                handler: function () {
                                    if (formSearchUnificado.getForm().isValid()) {
                                        if (formSearchUnificado.getForm().isValid()) {
                                            var store = new Ext.data.JsonStore({
                                                url: Ext.SROOT + 'swi/simgeisrv/buscarunificado',
                                                root: 'data',
                                                fields: [
                                                    {name: 'id'},
                                                    {name: 'codigo'}
